...
public class typo_squatting {

        private final HashMap<String, Integer> nWords = new HashMap<String, Integer>();

	public typo_squatting(String file) throws IOException {
	...
	/*public static void main(String args[]) throws IOException {
                String inp = "gutonborg";
		//if(args.length > 0) System.out.println((new Spelling("big.txt")).correct(args[0]));
                System.out.println((new Spelling("big.txt")).correct(inp));
